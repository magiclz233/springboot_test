...
import com.cnpc.repository.test1.UserTest1Repository;
import com.cnpc.repository.test2.UserTest2Repository;
...
public class UserRepositoryTests {
	...
	public void testSave() throws Exception {
		...
		userTest1Repository.save(new User("122213a", "aa123213456","aa@1221313126.com", "aa",  formattedDate));
		userTest1Repository.save(new User("b23121b", "bb123432156","bb@1212312126.com", "bb",  formattedDate));
