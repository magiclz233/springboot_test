package com.cnpc.mail;

import com.cnpc.service.MailService;
...
public class MailServiceTest {
    ...
    public void testSimpleMail() throws Exception {
        mailService.sendSimpleMail("xx@qq.com","simple mail"," hello this is simple mail");
    }
    ...
    public void testHtmlMail() throws Exception {
        String content="<html>\n" +
                ...
                "</body>\n" +
                "</html>";
        mailService.sendHtmlMail("xx@qq.com","test simple mail",content);
    }
